...
export const IntegrationScalarFieldEnumSchema = z.enum(['id','userId','type','providerUserId','accessToken','refreshToken','tokenExpiration','watchExpiration','scopes','createdAt','lastUsedAt','lastRefreshedAt','status','metadata']);
