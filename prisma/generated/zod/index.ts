...
export const UserScalarFieldEnumSchema = z.enum(['id','userId','email','name','createdAt','updatedAt']);

export const IntegrationScalarFieldEnumSchema = z.enum(['id','userId','type','providerUserId','accessToken','refreshToken','tokenExpiration','scopes','createdAt','lastUsedAt','lastRefreshedAt','status','metadata']);
...
export const IntegrationTypeSchema = z.enum(['GMAIL','SLACK','OUTLOOK','GITHUB']);
